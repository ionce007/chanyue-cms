<template>
  ...
  >
    ...
    <el-table-column align="center" prop="product" label="咨询产品"></el-table-column>
    <el-table-column align="center" prop="remarks" label="留言"></el-table-column>
...
import { search, del } from "../../api/appointment.js";
