<template>
  <el-row type="flex" justify="space-between">
    ...
    <router-link class="c-fff add-btn" to="/caseCategory/add">新增</router-link>
  </el-row>
...
import { search, del } from "../../api/caseCategory.js";
...
export default {
  ...
  methods: {
    ...
    toEdit(e) {
      let id = e.id;
      this.$router.push({ name: "caseCatagory-edit", params: { id: id } });
    },
